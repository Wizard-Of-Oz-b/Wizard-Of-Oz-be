...
from .views_products import ProductDetailAPI, ProductImagesAPI, ProductListCreateAPI
...
urlpatterns = [
    ...
    path(
        "<uuid:product_id>/images/", ProductImagesAPI.as_view(), name="product-images"
    ),
    # /api/v1/products/<product_id>/reviews/
    path(
        "<uuid:product_id>/reviews/",

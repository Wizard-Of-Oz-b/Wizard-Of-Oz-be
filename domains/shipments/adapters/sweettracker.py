...
class SweetTrackerAdapter:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv(
            "SMARTPARCEL_HOST", "https://trace-api.sweettracker.net"
        )
    ...
    def fetch_tracking(
        ...
        try:
            ...
            logger.info(
                f"Fetching tracking info from SweetTracker: {url} with params: {params}"
            )
    ...
    def _parse_sweettracker_response(
        self, data: Dict[str, Any], tracking_number: str, carrier: str
    ) -> Dict[str, Any]:
        """
            ...
            out.append(
                {
                    ...
                    "status": e.get("status"),
                    "provider_code": e.get("carrier_code")
                    or raw.get("carrier")

...
class WishlistItem(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["user", "product", "option_key"], name="uq_wishlist_user_product_option"),
        ]
        indexes = [models.Index(fields=["user", "-created_at"]), models.Index(fields=["product"])]
